  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {!noPanel ? [
          <button aria-label="toggles vertical" key="v" className={s('grid__button', { verticalIsVisible })} onClick={this.onToggleVertical}>
          ...
          <button aria-label="toggle horizontal" key="h" className={s('grid__button', { horizontalIsVisible })} onClick={this.onToggleHorizontal}>
            <svg className={s.grid__button__svg} width="14px" height="14px" viewBox="0 0 14 14">
